...
You can contribute using your favorite modern development tools and AI assistants:

- **GitHub Copilot Chat** for AI-powered code assistance
- **IDE integrations** with VS Code, JetBrains, and more
- **Agentic coding tools** with MCP support (Cursor, Claude, Aider)
- **Raycast on macOS** for streamlined workflows
- **CLI tools** for automated contribution processes

**Quick start**: [Modern Tools Quick Reference](docs/QUICK_START_MODERN_TOOLS.md)  
**Detailed guide**: [Modern Development Workflows](docs/MODERN_DEVELOPMENT_WORKFLOWS.md)
